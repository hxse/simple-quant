...
def get_data(name, frequency, count, refresh=True):
    # http://127.0.0.1:8000/ohlcv?name=SHFE.RB&frequency=300s&count=200&refresh=true&testUpdate=False&splitStart=5&splitEnd=10
    url = f"http://127.0.0.1:8000/ohlcv?name={name}&frequency={frequency}&count={count}&refresh={refresh}"
